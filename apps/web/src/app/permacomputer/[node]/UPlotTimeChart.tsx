    ...
    const opts: uPlot.Options = {
      ...
      hooks: {
        ...
        setCursor: [(u) => {
          ...
          // Build the full date+time string once and stamp it into each
          // value label below. The top-of-chart cursor pill was removed
          // because it duplicated this timestamp redundantly.
          let fullStamp = '';
